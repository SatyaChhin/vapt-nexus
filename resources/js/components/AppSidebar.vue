...
import { Folder, FolderKanban, LayoutGrid, ServerCog } from '@lucide/vue';
...
import { index as projects, show as showProject } from '@/routes/projects';
...
const mainNavItems = computed<NavItem[]>(() => [
    { title: 'Dashboard', href: dashboard(), icon: LayoutGrid },
    {
        ...
        href: projects(),
        icon: FolderKanban,
        items: (page.props.sidebarProjects ?? []).map((project) => ({
            title: project.name,
